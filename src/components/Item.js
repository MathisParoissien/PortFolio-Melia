...
function Item(props) {
  ...
  return (
      <div
      style={{ backgroundImage: `url(${props.project.image})`,  backgroundRepeat: 'no-repeat' }}
    ...
    >
      ...
      { props.parent === false && 
        <MyVerticallyCenteredModal image={props.project.image} show={open} onHide={() => { handleShow(); console.log('open ->', open) }}/>
      }
